...
RUN_TAG="s1_grid_b1e-4_precsig_abs_l0p05_k0p5"
...
PYTHONUNBUFFERED=1 python train_run.py \
  ...
  --wandb_tags    "precision_signal_abs" "beta1e-4" "lambda0p05" "kappa0p5" "overcomplete" "no_sigreg" \
  2>&1 | tee -a "$LOG"
